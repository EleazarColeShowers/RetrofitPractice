...
dependencies {
    ...
    //retrofit
    implementation("com.squareup.retrofit2:retrofit:2.9.0")  //main retrofit dependency
    implementation("com.squareup.retrofit2:converter-gson:2.9.0") //json converter that converts json to data class
